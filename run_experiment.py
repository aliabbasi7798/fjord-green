...
def run_experiment(args_):
    ...
    while current_round <= args_.n_rounds:
        ...
        if (modeProject == 1):
            ...
            if(totalEnergy < 100):
                comuEng, compEng = Carbon.carbonEmission(8 , 41 , 10 , 4 , 10 , 10, 5, 2000 , 6000 , 2 , p , energyC , carbon)
...
if __name__ == "__main__":
    ...
    # name of csv file
    filename = "Non_IID_emnist-E=5_1cluster(m=0.6,sd=0)_fixcarbon100_feq3.csv"
