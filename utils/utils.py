...
def get_learner(
    ...
    if name == "synthetic":
        ...
        model = FjordFemnistCNN(num_classes=62).to(device)
        is_binary_classification = False
...
def get_client(
    ...
    :param local_steps:
    :param tune_locally
    :param k: dropout parameter to build set of values
    :return:
...
def get_aggregator(
    ...
    :param k: value for sampling dropout P={i/k} is a set of all droupout rates
    ...
    elif aggregator_type == "fjord":
        return FjordAggregator(
            clients=clients,
            global_learners_ensemble=global_learners_ensemble,
            log_freq=log_freq,
            global_train_logger=global_train_logger,
            ...
            verbose=verbose,
            seed=seed,
            k=k #dropout uniform parameter for building set of dropout rates
        )
